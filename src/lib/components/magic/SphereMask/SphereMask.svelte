...
<div
	class={cn(
		// color: use a very light gray for the sphere
		...
		// before: lighter radial gradient
		...
		// after: white background, light gray border
		'after:absolute after:-left-1/2 after:top-1/2 after:aspect-[1/0.7] after:w-[200%] after:rounded-[50%] after:border-t after:border-[#e5e7eb] after:bg-white'
	)}
></div>
